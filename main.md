<div style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 5px; padding: 12px 16px; margin-bottom: 20px; color: #664d03;">
Αυτό το σεμινάριο διδάχθηκε το 2014 και διατηρείται για ιστορικούς λόγους. Κάποια εργαλεία και υπηρεσίες που αναφέρονται ενδέχεται να μην είναι πλέον διαθέσιμα.
</div>
...
---------------------
Θα χαρούμε να διαφημίσεις το σεμινάριο στους φίλους σου και σε άλλα πρόσωπα που πιστεύεις πως μπορεί να ενδιαφέρονται.
